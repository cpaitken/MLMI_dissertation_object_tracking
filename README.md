...
Visualizers:
    Individual files to plot some of the figures within "Tracking of Erratically Moving Objects Using (non)-Gaussian Process Models".
    Comments describing the specific figure any particular file visualizes can be found in the first few lines.
